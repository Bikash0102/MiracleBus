    ...
    <section className="relative pt-40 pb-24">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-8">
        <div className="flex items-center flex-col justify-center sm:justify-start relative z-10 mb-5">
          ...
          <div className="block">
            <h3 className="font-manrope font-bold text-4xl text-gray-900 mb-1 max-sm:text-center">{authUser.fullName}</h3>
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mb-8">
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="flex items-center">
               ...
               <span className="text-gray-700">Phone:<span>9533118149 </span> </span>
            </div>
            <div className="flex items-center">
           ...
           <svg className="w-6 h-6 text-gray-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
             ...
             <span className="text-gray-700">Age:22</span>
             </div>
            <div className="flex items-center">
            <svg className="w-6 h-6 text-gray-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
           ...
           <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-700">Address: 123 Main St, New York, NY</span>
            </div>
          </div>
        </div>
